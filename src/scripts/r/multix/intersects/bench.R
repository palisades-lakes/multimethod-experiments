...
bench2 <- read.data(folder,model,baseline.generator,bench.generator,nelements,theday)
bench9 <- read.data(folder,model,bench.generator,bench.generator,nelements,theday)
#-----------------------------------------------------------------
